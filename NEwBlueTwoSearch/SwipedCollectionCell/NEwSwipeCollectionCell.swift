...
fileprivate extension UICollectionView {
    struct AssociatedKeys {
        static var currentcell = "pzswipe_currentCell"
    }
    var openingCell: NEwSwipeCollectionCell? {
        get {
            return objc_getAssociatedObject(self, &AssociatedKeys.currentcell) as? NEwSwipeCollectionCell
        }
        set {
            if let newValue = newValue {
                objc_setAssociatedObject(
                    ...
                    newValue as NEwSwipeCollectionCell?,
...
// MARK: -
class NEwSwipeCollectionCell: UICollectionViewCell,UIGestureRecognizerDelegate {
